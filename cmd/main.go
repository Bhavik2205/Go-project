...
// 	// ─── Validate Zerodha Session (Need to make it optional so that if we are on live mode then only get here) ───────────────────────────────────────────────
// 	if !appCfg.Market.Simulate {
...
// 	// server.SetZerodhaClient(client) // Moved to earlier in the code (NEED CHECK)
// 	// server.SetDBClient(dbClient) // Moved to earlier in the code (NEED CHECK)
// 	// server.SetRedisClient(redisClient) // Moved to earlier in the code (NEED CHECK)
